...
gulp.task('serve', ['sass', 'lint'], function() {
  ...
  gulp.watch("app/js/**/*", ['lint']).on('change', browserSync.reload);
});
...
gulp.task('copy-to-dist', function(){
  return gulp.src(['app/**/*', '!app/sass{,/**}', '!app/img{,/**}', '!app/js{,/**}'], {base: "./app"})
    .pipe(gulp.dest('dist'));
});
...
gulp.task('dist', function(callback) {
  runSequence('lint', 'clean-dist', 'sass-dist', 'copy-to-dist', 'copy-images', 'copy-js');
});